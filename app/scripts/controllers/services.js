...
angular.module('ubicameUdeaApp.services', [])
    ...
    return $resource('https://ubicame-udea.herokuapp.com/bloques/:id', { id : '@_id' }, {
	...
	return $resource('https://ubicame-udea.herokuapp.com/tiposunidad/:id', { id : '@_id' }, {
	...
	return $resource('https://ubicame-udea.herokuapp.com/unidades/:id', { id : '@_id' }, {
	...
	return $resource('https://ubicame-udea.herokuapp.com/departamentos/:id', { id : '@_id' }, {
	...
	return $resource('https://ubicame-udea.herokuapp.com/ubicaciones/:id', { id : '@_id' }, {
	...
	return $resource('https://ubicame-udea.herokuapp.com/usuarios/:id', { id : '@_id' }, {
